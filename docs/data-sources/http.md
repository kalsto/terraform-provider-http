...
- `location` (String) The URL from the request that was sent ot obtain the final response. If the final server response included a Location header then this value is set to the absolute path of that location, relative to the URL that made the request.
